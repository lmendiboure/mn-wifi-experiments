...
""" Open, read and close config file - then data can be used
"""
    ...
    net.telemetry(nodes=nodes, data_type=data['telemetry']['data-type'],
                  min_x=int(data['telemetry']['min-x']), min_y=int(data['telemetry']['min-y']),
                  max_x=int(data['telemetry']['max-x']), max_y=int(data['telemetry']['max-y']))
