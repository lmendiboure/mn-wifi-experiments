...
# Note : car0 do not exist

    liste=['car1','car5','car15']
    for el in liste:
    	node = net.get(el)
    	result = node.cmd('ifconfig')
    	print(result)
    	
# Note : Everything can be used within cmd, including the possibility to run a script and to attach args to this script 
